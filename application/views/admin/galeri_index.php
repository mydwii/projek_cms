...
<div class="row">
    <?php foreach ($galeri as $ab) { ?>
        <div class="col-lg-4">
            <div class="card">
                <img src="<?= base_url('assets/upload/galeri/' . $ab['foto']) ?>" class="card-img-top">
                <div class="card-body">
                    <h5 class="card-title"><?= $ab['judul'] ?></h5>
                    <a href="<?= site_url('admin/galeri/delete_data/' . $ab['foto']) ?>" class="btn btn-sm btn-danger mr-2" onClick="return confirm('Apakah anda yakin akan menghapus?')">
